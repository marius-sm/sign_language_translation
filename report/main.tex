...
\begin{figure}[h]
	...
	\begin{subfigure}[t]{0.5\linewidth}
		...
		\caption{R(2+1)D pre-trained on time arrow prediction}
	\end{subfigure}\hfill
	\begin{subfigure}[t]{0.5\linewidth}
		\centering\captionsetup{width=.9\linewidth, justification=raggedright}
		\includegraphics[height=1.8cm]{fig/matrices/a_vcop}
		\includegraphics[height=1.8cm]{fig/matrices/b_vcop}
		\caption{R(2+1)D pre-trained on clip order prediction}
	\end{subfigure}
	\par\medskip
	\centering
